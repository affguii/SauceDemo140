...
class TestSelecionarProduto():
  def setup_method(self, method):
    ...
    self.vars = {}
    self.driver.implicitly_wait(5) # ira esperar qualquer elemento por ate 5 segundos <-- Melhor
  ...
  def test_selecionarProduto(self):
    ...
    # time.sleep(2) # parando o processamento / thread por 2 segundos <-- Pior - uso apenas temporario
